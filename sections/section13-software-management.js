    ...
    questionSets: {
        ...
        set2: [
            ...
            },
            {
                ...
                expected: [
                    { command: "ls", requiredFlags: ["-l"], requiredValues: ["/tmp/*.rpm"] },
                    { command: "find", requiredFlags: ["-name"], requiredValues: ["/tmp", "*.rpm"] }
                ],
            ...
            },
            {
                ...
                expected: [
                    { command: "du", requiredFlags: ["-s", "-h"], requiredValues: ["/var/cache/dnf"] },
                    { command: "du", requiredFlags: ["-s", "-h"], requiredValues: ["/var/cache/yum"] }
                ],
        ...
        set3: [
            ...
            },
            {
                ...
                expected: [
                    { command: "rpm", requiredFlags: ["-q", "-a", "--last"] },
                    { command: "rpm", requiredFlags: ["-q", "-a"], requiredValues: ["--last"] }
                ],
