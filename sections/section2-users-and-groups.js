    ...
    questionSets: {
        set1: [
            ...
            },
            {
                ...
                explanation: "Checking /etc/shadow confirms a password hash exists. passwd -S shows password status (P for set). chage -l displays password aging including if a password is set.",
                points: 2
            },
            {
                id: 7,
        ...
        set2: [
            ...
            },
            {
                ...
                explanation: "A valid password shows as an encrypted hash in the second field of /etc/shadow. passwd -S shows password status (P for set). chage -l displays password aging including if a password is set.",
                points: 2
            },
            {
                id: 7,
        ...
        set4: [
            ...
            },
            {
                ...
                expected: [
                    { command: "ls", requiredFlags: ["-l", "-a"], requiredValues: ["/etc/sudoers.d/"] },
        ...
        set6: [
            ...
            },
            {
                ...
                expected: [
                    ...
                    { command: "grep", requiredValues: ["operator", "/etc/shadow"] },
                    { command: "chage", requiredFlags: ["-l"], requiredValues: ["operator"] }
                ],
                explanation: "passwd -S shows password status (P for set, NP for no password, L for locked). chage -l displays password aging including if a password is set. Checking /etc/shadow confirms a password hash exists.",
                points: 2
            },
            {
                id: 3,
                ...
                expected: [
                    ...
                    { command: "id", requiredFlags: ["-u", "-n"], requiredValues: [] }
                ],
            ...
            },
            {
                ...
                allowedPreChecks: [
                    ...
                    { command: "ls", requiredFlags: ["-l", "-d"], requiredValues: ["/opt/appuser"] }
                ],
