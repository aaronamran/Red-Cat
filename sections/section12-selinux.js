    ...
    questionSets: {
        ...
        set1: [
            ...
            },
            {
                ...
                expected: [
                    ...
                    { command: "ls", requiredFlags: ["-l", "-Z"], requiredValues: ["/var/www/html"] }
                ],
                allowedPreChecks: [],
        ...
        set2: [
            {
                ...
                expected: [
                    { command: "ls", requiredFlags: ["-Z", "-d"], requiredValues: ["/var/www/html"] },
            ...
            },
            {
                ...
                expected: [
                    { command: "restorecon", requiredFlags: ["-R", "-v"], requiredValues: ["/web"] }
                ],
            ...
            },
            {
                ...
                expected: [
                    ...
                    { command: "ps", requiredFlags: ["-e", "-Z"], requiredValues: ["|", "grep", "httpd"] }
                ],
                allowedPreChecks: [
            ...
            },
            {
                ...
                expected: [
                    { command: "find", requiredFlags: ["-context"], requiredValues: ["/tmp", "*:user_home_t:*"] },
                    { command: "find", requiredFlags: ["-context"], requiredValues: ["/tmp", "user_home_t"] }
                ],
            ...
            },
            {
                ...
                allowedPreChecks: [
                    { command: "ls", requiredFlags: ["-Z", "-d"], requiredValues: ["/usr/share"] }
                ],
        ...
        set4: [
            ...
            },
            {
                ...
                allowedPreChecks: [
                    { command: "ss", requiredFlags: ["-t", "-u", "-l", "-n"], requiredValues: [] }
                ],
        ...
        set6: [
            ...
            },
            {
                ...
                expected: [
                    { command: "restorecon", requiredFlags: ["-R", "-n"], requiredValues: ["/var/www"] },
            ...
            },
            {
                ...
                expected: [
                    { command: "ss", requiredFlags: ["-t", "-u", "-l", "-n", "-Z"], requiredValues: [] },
                    { command: "netstat", requiredFlags: ["-t", "-u", "-l", "-n", "-Z"], requiredValues: [] }
                ],
