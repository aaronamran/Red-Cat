const section15Data = {
    ...
    description: "Manage systemd targets, GRUB2, and boot process",
    totalPoints: 30,
    questionSets: {
        ...
        */ // End PHASE 2 - Set 3
        ...
        set4: [
            ...
            },
            {
                ...
                expected: [
                    ...
                    { command: "ls", requiredFlags: ["-l", "-h"], requiredValues: ["/boot"] }
                ],
        ...
        , set6: [
            ...
            },
            {
                ...
                expected: [
                    { command: "journalctl", requiredFlags: ["-x", "-b"], requiredValues: [] },
