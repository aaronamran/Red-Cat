    ...
    questionSets: {
        set1: [
            ...
            },
            {
                ...
                allowedPreChecks: [
                    { command: "ls", requiredFlags: ["-l", "-d"], requiredValues: ["/mnt/nfsdata"] }
                ],
        ...
        set2: [
            ...
            },
            {
                ...
                allowedPreChecks: [
                    { command: "ls", requiredFlags: ["-l", "-d"], requiredValues: ["/mnt/shared"] },
        ...
        set3: [
            ...
            },
            {
                ...
                allowedPreChecks: [
                    { command: "ls", requiredFlags: ["-l", "-d"], requiredValues: ["/mnt/backups"] },
        ...
        set5: [
            ...
            },
            {
                ...
                expected: [
                    ...
                    { command: "mount", requiredFlags: ["-f", "-a", "-v"], requiredValues: [] }
                ],
        ...
        set6: [
            ...
            },
            {
                ...
                expected: [
                    { command: "nc", requiredFlags: ["-z", "-v"], requiredValues: ["192.168.1.10", "2049"] },
            ...
            },
            {
                ...
                expected: [
                    ...
                    { command: "find", requiredFlags: ["-type"], requiredValues: ["/mnt/nfs", "f"] }
                ],
